...
<body>  
    ...
    <section class="home-section">
        ...
        <div class="Create-route">
            <br>
            <form class="form" method="post" action="submitAddBus.php">
            <div class="input_container">
            <label class="input_label" >Bus Number :</label>
            <input class="input_field" type="text" name="Bus_Number">
            
            <label class="input_label" >Driver</label>
            <input class="input_field" type="text" name="Driver">
            ...
            <select class="input_field" name="RID">
             ...
             <input  type="radio" id="noac" name="type" value="NON A/C" required>
             
             <label class="input_label">Charge :</label>
            <input class="input_field" type="text" name="Charges">
            <button type="submit" >AddBus</button>
                </div>
            </form>
